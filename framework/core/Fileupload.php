 ...
 * File Uploader Class
 *
 * Validate, Remove and Upload files to server.
 * Don't forget to check the options file_uploads, upload_max_filesize, max_file_uploads and post_max_size in the php.ini
 ...
 * @version    1.0.0.2
 * @link       http://innostudio.de/fileuploader/
 **/
class Fileupload {
